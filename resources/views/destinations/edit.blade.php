                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <input type="date" name="tanggal_berangkat"
                               value="{{ old('tanggal_berangkat', \Carbon\Carbon::parse($destination->derparture_date)->format('Y-m-d')) }}"
                    ...
                    <div class="flex gap-3">
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="status" value="0" class="hidden peer"
                                   {{ old('status', $destination->is_completed) == '0' || old('status', $destination->is_completed) == false ? 'checked' : '' }}>
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="status" value="1" class="hidden peer"
                                   {{ old('status', $destination->is_completed) == '1' || old('status', $destination->is_completed) == true ? 'checked' : '' }}>
...
function editForm() {
    return {
        preview: '{{ $destination->image ? asset("storage/" . $destination->image) : "" }}' || null,
        dragging: false,
        handleFile(event) {
