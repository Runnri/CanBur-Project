...
<div class="max-w-xl mx-auto">
    ...
    <div class="card rounded-2xl px-5 py-3.5 flex items-center gap-3 mb-6">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-xs text-white/30 font-body">Mengedit kegiatan di destinasi</p>
            <p class="text-sm font-body font-medium text-white truncate">{{ $destination->judul }}</p>
        </div>
        <span class="text-xs font-body text-sand-400/70 shrink-0">
            Hari ke-{{ $plan->hari }}
        </span>
    </div>
        ...
        <div class="space-y-5">
            ...
            <div class="card rounded-3xl p-6 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="time"
                           name="jam"
                           value="{{ old('jam', \Carbon\Carbon::parse($plan->jam)->format('H:i')) }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="kegiatan"
                              ...
                              class="input-field w-full px-4 py-3 rounded-xl font-body text-sm resize-none leading-relaxed @error('kegiatan') border-red-500/50 @enderror">{{ old('kegiatan', $plan->kegiatan) }}</textarea>
                    @error('kegiatan')
                        <p class="text-red-400 text-xs font-body flex items-center gap-1">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            {{ $message }}
